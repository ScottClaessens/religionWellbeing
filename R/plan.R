...
plan <- drake_plan(
  ...
  f1.2.2 = forest2(m1.2, parameter = "religion"),
  ...
  f1.3.2 = forest2(m1.3, parameter = "religion:cnorm"),
  ...
  f2.2.2 = forest2(m2.2, parameter = "religion"),
  ...
  f2.3.2 = forest2(m2.3, parameter = "religion:cnorm"),
